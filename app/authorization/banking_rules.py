...
def create_legal_abac_rules():
    ...
    def senior_access(req: AuthorizationRequest) -> bool:
        return (
            ...
            req.action in {"view_case", "edit_case", "file_document", "bill_hours"}
        )
    ...
    def cross_location_deny(req: AuthorizationRequest) -> bool:
        return (
            req.user.attributes.role == 'attorney' and
    ...
    def junior_restriction(req: AuthorizationRequest) -> bool:
        return req.user.attributes.level == 'junior' and req.action in {"file_document", "bill_hours"}
...
def create_all_rules():
    ...
    return create_legal_abac_rules()
